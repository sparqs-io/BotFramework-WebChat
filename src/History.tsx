    ...
    render() {
        ...
        switch (this.props.activity.id) {
            ...
            default:
                ...
                console.log(this.props.activity.from);
                timeLine = <span>{ this.props.activity.from.name === 'Du' ? (this.props.activity.from.name || this.props.activity.from.id) + ' ' : '' }{ sent }</span>;
